...
public class Controller {
    ...
    public void rusSelected() {
        ...
        label.setText("Посчитатлка - просто выберите текстовый файл и вам всё посчитают");
        label.setStyle("-fx-font: 15 arial;");
        Button.setText("Выбрать файл");
        Tog.setText("Посчитать");
        Tog.setStyle("-fx-font: 13 arial;");
        RadioButtonRus.setText("Русский");
        RadioButtonEng.setText("Английский");
        RadioButtonEng.setStyle("-fx-font: 11 arial");
    ...
    public void engSelected() {
        ...
        label.setText("Counter -> Just select a text format file and see for yourself");
        label.setStyle("-fx-font: 17 arial;");
        Button.setText("Choose a File");
        Tog.setText("Counter");
        Tog.setStyle("-fx-font: 17 arial;");
        RadioButtonRus.setText("Rus");
        RadioButtonEng.setText("Eng");
        RadioButtonEng.setStyle("-fx-font: 12 arial");
